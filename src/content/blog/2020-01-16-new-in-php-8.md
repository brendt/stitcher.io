PHP 8 will be released on [December 3, 2020](*https://wiki.php.net/todo/php80). It's a new major version, which means that it will introduce some breaking changes, as well as lots of new features and performance improvements. PHP 8 is in very active development right now, with its first alpha expected on June 18, 2020. 
...
There are lots of variations of this syntax, head over to the [RFC](*https://wiki.php.net/rfc/constructor_promotion) to read about them.
