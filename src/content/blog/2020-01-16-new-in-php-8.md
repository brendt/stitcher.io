PHP 8, the new major PHP version, is expected to be released on [December 3, 2020](*https://wiki.php.net/todo/php80). It's in very active development right now, so things are likely to change a lot in the upcoming months.
