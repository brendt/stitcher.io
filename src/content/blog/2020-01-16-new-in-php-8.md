```php
#[<hljs type>InitilizedBy</hljs>(<hljs type>RouterInitializer</hljs>::class)]
class Router
{
    public function __construct(
        <hljs keyword>public</hljs> <hljs type>RouteCollector</hljs> <hljs prop>$collector</hljs>
    ) {}
    
    public function handle(<hljs type>int|string</hljs> $id, <hljs type>array</hljs> $query, <hljs type>array</hljs> $body): <hljs type>Route</hljs>
    { /* … */ }
}


$router-><hljs prop>handle</hljs>(
    <hljs prop>id</hljs>: $id,
    <hljs prop>body</hljs>: $body,
);
```
