...
### `::class` on objects <small>[RFC](*https://wiki.php.net/rfc/class_name_literal_on_object)</small>
...
### `Stringable` interface <small>[RFC](*https://wiki.php.net/rfc/stringable)</small>
