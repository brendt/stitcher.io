PHP 8 is here! It was released on November 26, 2020. You can [download it here](*https://www.php.net/releases/8.0/en.php). It's a new major version, which means that it will introduce some breaking changes, as well as lots of new features and performance improvements. 
...
[PHP 8.1](/blog/new-in-php-81) is currently in development and will be released at the end of 2021, you can read about its process [here](/blog/new-in-php-81). 
</div>
