...
### New Random extension <small>[RFC](https://wiki.php.net/rfc/random_extension_improvement)</small>

This extension was already in the works, although there were still a bunch of quirks that prevented it from being added in earlier versions. This RFC addresses these quirks, meaning that the extension will now be available in 8.2. 
