...
### Improvements to the Random extension <small>[RFC](https://wiki.php.net/rfc/random_extension_improvement)</small>

PHP's Random extension had a bunch of quirks that were overlooked when it was first added. This RFC fixes many of those quirks.
