PHP 8.1 will be released on [November 25, 2021](*https://wiki.php.net/todo/php81). We already know all new features, performance improvements, changes and deprecations; so let's go through them one by one.
...
Note that this RFC is still being voted on, but it's already clear that it will pass.
