PHP 8.1 was released on [November 25, 2021](*https://wiki.php.net/todo/php81). In this post, we'll go through all features, performance improvements, changes and deprecations one by one.
