...
<h1>What's new in PHP 7.4</h1>

((PHP 7.4)) will be released on [November ((#28#)), ((#2019#))](*https://wiki.php.net/todo/php74). Here are some highlights of new features and changes: 

- [Arrow functions](#short-closures-rfc) for cleaner one-liner functions
...
((PHP 7.4)) comes with a remarkable amount of new features. Here's a list of everything tat was added with this release.
...
### Short open tags deprecated <small>[RFC](*https://wiki.php.net/rfc/deprecate_php_short_tags)</small>
...
### Improvements to `password_hash` <small>[rfc](*https://wiki.php.net/rfc/sodium.argon.hash)</small>

This is a small change adds `argon2i` and `argon2id` hashing support when PHP was compiled without `libargon`. 
...
### Other incompatible changes <small>[UPGRADING](*https://github.com/php/php-src/blob/PHP-7.4/UPGRADING)</small>
