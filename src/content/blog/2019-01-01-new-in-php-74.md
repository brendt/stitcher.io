...
((PHP 7.4)), the latest version before ((PHP 8)), brings lots of new features, syntax additions and fixes. Features like short closures and typed properties help the language mature more and more. We can expect ((PHP 7.4)) to be released on November 28, 2019. In this post you'll find a list with everything that's new and changed, but let's start with a few highlights, included in ((PHP 7.4)):
