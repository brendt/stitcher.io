...
While definitely a great feature, it's unfortunate that it doesn't work with cloning public readonly properties; unless you specifically reset the propery's write access to `{php}public(set)`. [I wrote about the problem here](/blog/readonly-or-private-set).
