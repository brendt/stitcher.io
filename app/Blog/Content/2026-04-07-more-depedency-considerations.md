...
So what the folks at Paragonie are saying: by removing the dependency on `paragonie/sodium_compat` in awesome-lib, some systems might not be able to update to newer versions of awesome-lib anymore. Let's explore that problem, though:
