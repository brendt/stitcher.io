...
next: new-in-php-74
meta:
    description: 'The pros and cons of adding a JIT compiler to PHP.'
footnotes:
    - { link: /blog/jit-in-real-life-web-applications, title: 'Real life benchmarks of the JIT' }
...
If you want to personally reach out, you can find me on [Twitter](*https://twitter.com/brendt_gd) or via [e-mail](mailto:brendt@stitcher.io)!
