...
### Return type changes for `DateTime::createFromImmutable()` and `DateTimeImmutable::createFromMutable()` <small class="breaking">[breaking](https://github.com/php/php-src/blob/master/UPGRADING#L22-L26)</small>
...
### Locale-insensitive `strtolower()` and `strtoupper()` <small class="breaking">[breaking](https://github.com/php/php-src/blob/master/UPGRADING#L41-L47)</small> <small>[RFC](*https://wiki.php.net/rfc/strtolower-ascii)</small>
