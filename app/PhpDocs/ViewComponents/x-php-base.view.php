...
<main :class="$noPadding ? 'flex flex-col mx-auto grow' : 'flex mx-auto px-4 xl:px-8 gap-4 grow mb-16 mt-4 md:mt-0'">
    {{--
    ...
    <div :class="$noPadding ? 'w-full' : 'w-full lg:max-w-[1200px] mx-auto'">
        <x-slot/>
    </div>
</main>
