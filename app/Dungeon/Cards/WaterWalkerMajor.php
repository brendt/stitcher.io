...
final class WaterWalkerMajor implements Card, PassiveCard
{
    use IsCard;

    public string $name = 'Water Strider';
    ...
    public string $image = '/cards/water-walker-major.png';

    public int $price = 30_000;
