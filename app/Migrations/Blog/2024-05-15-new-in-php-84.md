PHP 8.4 was released on [November 21, 2024](https://wiki.php.net/todo/php84). It'll include property hooks, HTML 5 support, as well as chaining methods on `{php}new` without additional parentheses — a big one!
