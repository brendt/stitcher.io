---
title: 'The 100-million-row challenge'
pretext: "I'm organising a challenge for all of you to participate in"
---

Hi ::subscriber.first_name::

A month ago, I went on a [performance quest](/blog/11-million-rows-in-seconds), trying to optimize a PHP script that took 5 days to run. Together with the help of many talented developers, I eventually got it to run in under 30 seconds. This optimization process with so much fun, and so many people pitched in with their ideas; so I eventually decided I wanted to do something more.
...
So, are you ready to participate? Head over to the [challenge repository](https://stitcher.io/feed/posts/74302) and give it your best shot!
